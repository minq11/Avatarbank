...
_INSTRUCTION = (
    ...
    "3. Never drop anything the user wrote. Every noun the user typed must appear "
    "in the translation.\n"
    "4. Do not INVENT a subject. If the user never mentioned a person, do not add "
    "'a woman', 'a man', 'a girl', 'a person', 'she' or 'he' — the subject's "
    "gender, age and nationality are added separately before your text.\n"
    "   But if the user DID write a person (여자, 남자, 소녀, 커플 …), translate "
    "that word. Rule 3 wins over rule 4: only invention is forbidden, never "
    "deletion.\n"
    ...
    "          (no person written → none added)\n"
    "  input : 해변의 금발의 여자\n"
    "  output: a blonde woman at the beach\n"
    "          (person written → kept)\n"
