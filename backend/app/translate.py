...
_INSTRUCTION = (
    ...
    "2. Keep the user's intent and every concrete detail (clothing, pose, place, "
    "time of day, mood, camera framing).\n"
    "3. Write it as a natural English image prompt: comma-separated descriptive "
    "phrases, not a full sentence.\n"
    "4. Do not add people, nudity, brands, or text that the user did not ask for.\n"
